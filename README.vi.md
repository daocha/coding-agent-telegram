<div align="center">
  ...
  <p><strong>Nhẹ, nhiều bot, nhiều phiên, đa nhiệm, AI Coding Agent hoạt động 24/7</strong></p>
  <p>Điều khiển AI coding agent cục bộ của bạn từ bất cứ đâu qua Telegram.</p>
  <p>
...
<table border="0">
   ...
   ## 🔁 Chuyển thiết bị/phiên làm việc liền mạch
   ...
   ## 🛠️ Quy trình dùng cục bộ điển hình
   ```bash
